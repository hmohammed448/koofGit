        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
              ...
              <li>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `${
                      isActive &&
                      "text-white font-bold bg-orange-500 rounded-lg"
          ...
          <div className="hidden w-full md:block md:w-auto" id="navbar-default">
            <Link
              to="#"
              type="button"
              className="authBtn text-white bg-orange-700 hover:bg-orange-800 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-orange-600 dark:hover:bg-orange-500 focus:outline-none"
            >
              Sign up
            </Link>
            <Link
